...
import { ConfirmModal, SortableLessonItem, SortableWeekCard } from "./components";
...
export default function CurriculumBuilderPage() {
  ...
  const [addingLessonToWeekId, setAddingLessonToWeekId] = useState<
    string | null
  >(null);

  // Week form
  const [newWeek, setNewWeek] = useState<CurriculumWeekCreate>({
    week_number: 1,
    theme: "",
    objectives: "",
  });
  ...
  // Lesson form
  const [newLesson, setNewLesson] = useState<CurriculumLessonCreate>({
    title: "",
    description: "",
    duration_minutes: 30,
    video_url: "",
  ...
  // Skill form
  const [newSkill, setNewSkill] = useState<SkillCreate>({
    name: "",
    category: "technique",
    description: "",
  });
  ...
  async function handleAddWeek() {
    ...
    try {
      ...
      setNewWeek({
        week_number: (curriculum.weeks.length || 0) + 1,
        theme: "",
        objectives: "",
      });
  ...
  function handleDeleteLesson(lessonId: string) {
    showConfirm("Delete Lesson", "Delete this lesson?", async () => {
      closeConfirm();
      try {
  ...
  async function handleLessonDragEnd(weekId: string, event: DragEndEvent) {
    ...
    // Save to backend
    try {
      await AcademyApi.reorderLessons(
        weekId,
        ...
        <header className="flex items-center justify-between">
          <div className="space-y-1">
            <div className="flex items-center gap-2 text-sm text-slate-500">
              ...
              <button
                onClick={() =>
                  router.push(`/admin/academy/programs/${programId}`)
                }
                className="hover:text-slate-900"
              >
                {program.name}
              ...
              <Card>
                <div className="text-center py-8">
                  <p className="text-slate-600 mb-4">
                    No curriculum has been created for this program yet.
                  </p>
                  <button
                ...
                <Card>
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      onClick={() => {
                        setNewWeek({
                          week_number: curriculum.weeks.length + 1,
                          theme: "",
                          objectives: "",
                        });
                        setShowAddWeek(true);
                    ...
                    <div className="grid gap-4 md:grid-cols-3">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          value={newWeek.theme}
                          onChange={(e) =>
                            setNewWeek({ ...newWeek, theme: e.target.value })
                          }
                            ...
                            >
                              ...
                              <div className="mt-4 pt-4 border-t border-slate-200">
                                ...
                                {addingLessonToWeekId === week.id ? (
                                  ...
                                  <button
                                    onClick={() =>
                                      setAddingLessonToWeekId(week.id)
                                    }
