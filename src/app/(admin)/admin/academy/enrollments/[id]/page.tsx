...
import { AcademyApi, Cohort, Enrollment, EnrollmentStatus, PaymentStatus } from "@/lib/academy";
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-amber-700">Payment has been received. Approve to activate enrollment.</p>
                            </div>
                        </div>
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-purple-700">Promote to pending approval when a spot opens.</p>
                            </div>
                        </div>
                        <Button
                            variant="secondary"
                            ...
                            <div>
                                ...
                                {enrollment.cohort && (
                                    <p className="text-sm text-slate-500 mt-1">
                                        {formatDate(enrollment.cohort.start_date)} - {formatDate(enrollment.cohort.end_date)}
                                    </p>
                                )}
                            </div>
                        </div>

                        {enrollment.preferences && Object.keys(enrollment.preferences).length > 0 && (
                            <div className="mt-4 pt-4 border-t">
                            ...
                            {(enrollment as any).enrolled_at && (
                                <div className="flex gap-3">
                                    ...
                                    <div className="pb-4">
                                        ...
                                        <p className="text-xs text-slate-500">{formatDate((enrollment as any).enrolled_at)}</p>
                                    </div>
                                </div>
                            )}
                            {(enrollment as any).paid_at && (
                                <div className="flex gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-slate-500">{formatDate((enrollment as any).paid_at)}</p>
                                    </div>
                                </div>
                            )}
                        </div>
