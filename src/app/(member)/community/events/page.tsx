        ...
        <div className="mx-auto max-w-6xl space-y-6 py-4 md:py-8">
            ...
            <div className="flex flex-wrap items-center gap-2 md:gap-3">
                ...
                <button
                    ...
                    className={`rounded-full px-3 md:px-4 py-1.5 text-xs md:text-sm font-medium transition-colors ${filterType === "all"
                ...
                {eventTypes.map((type) => (
                    <button
                        ...
                        className={`rounded-full px-3 md:px-4 py-1.5 text-xs md:text-sm font-medium transition-colors ${filterType === type
                            ? "bg-cyan-600 text-white"
                            : "bg-slate-100 text-slate-700 hover:bg-slate-200"
                            }`}
                    >
                            ...
                            <Card className="group h-full transition-all hover:shadow-lg">
                                <div className="space-y-4">
                                    ...
                                    <div className="flex items-center justify-between">
                                        <span
                                            className={`rounded-full px-3 py-1 text-xs font-semibold ${eventTypeColors[event.event_type] || "bg-slate-100 text-slate-700"
                                                }`}
                                        >
