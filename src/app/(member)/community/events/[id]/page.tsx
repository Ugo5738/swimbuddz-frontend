                ...
                <Card className="p-6">
                    ...
                    {isFullyBooked && userRsvp !== "going" ? (
                        <div className="rounded-lg bg-amber-50 p-4 text-sm text-amber-900">
                            <strong>Event is fully booked.</strong> You can still mark yourself as "Maybe" to be notified if spots open up.
                        </div>
                    ) : null}
                    ...
                    <div className="mt-4 grid gap-3 sm:grid-cols-3">
                        <button
                            ...
                            className={`flex items-center justify-center gap-2 rounded-lg border-2 px-4 py-3 font-medium transition-all ${userRsvp === "going"
                        ...
                        <button
                            ...
                            disabled={!!submitting}
                            className={`flex items-center justify-center gap-2 rounded-lg border-2 px-4 py-3 font-medium transition-all ${userRsvp === "maybe"
                        ...
                        <button
                            ...
                            disabled={!!submitting}
                            className={`flex items-center justify-center gap-2 rounded-lg border-2 px-4 py-3 font-medium transition-all ${userRsvp === "not_going"
