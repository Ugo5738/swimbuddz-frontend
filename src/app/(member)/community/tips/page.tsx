        ...
        <div className="flex flex-wrap gap-2">
          {categories.map((category) => (
            <button
              ...
              className={`rounded-lg px-3 md:px-4 py-2 text-xs md:text-sm font-medium transition-colors capitalize ${
                  ...
                  <Card className="h-full transition-all hover:shadow-lg cursor-pointer group overflow-hidden">
                    ...
                    <div className="p-4 space-y-3">
                      ...
                      <div className="flex items-center justify-between">
                        <span
                          className={`inline-flex items-center gap-1 rounded-full px-2.5 py-1 text-xs font-medium capitalize ${style.bg} ${style.text}`}
                        >
