            ...
            if (cohortData.program_id) {
                const [programData, milestonesData, curriculumData, enrollmentsData] =
                    await Promise.all([
                        ...
                        AcademyApi.getCurriculum(cohortData.program_id).catch(
                            () => null
                        ),
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                            <div>
                                ...
                                <p className="text-sm text-slate-600">
                                    View your progress and upcoming sessions in your
                                    dashboard.
                                </p>
                            </div>
                ...
                <div className="space-y-6">
                    ...
                    <Card className="p-6 bg-cyan-50 border-cyan-100">
                        ...
                        <p className="text-sm text-slate-600 mb-4">
                            Contact us to learn more about this program or get help
