  ...
  const loadData = async () => {
    try {
      ...
      const [
        ...
        AcademyApi.checkProgramInterest(programId).catch(() => ({
          registered: false,
        })),
      ]);
          ...
          <Card className="p-4 md:p-6">
            ...
            {cohorts.length === 0 ? (
              ...
              <div className="space-y-3 md:space-y-4">
                {cohorts.map((cohort) => {
                  const enrollment = getEnrollmentForCohort(cohort.id);
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        <Button
                          variant={isEnrolled ? "outline" : undefined}
                          className="w-full"
                          size="sm"
                        >
                          {isEnrolled ? "View Enrollment" : "View Details"}
                        </Button>
                      </Link>
                    </div>
                  );
