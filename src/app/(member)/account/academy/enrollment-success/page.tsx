...
import { AcademyApi, Enrollment } from "@/lib/academy";
...
function EnrollmentSuccessContent() {
    ...
    const loadEnrollment = async () => {
        try {
            const data = await AcademyApi.getEnrollment(enrollmentId!);
            setEnrollment(data);
        } catch (error) {
    ...
    const program = enrollment?.program || enrollment?.cohort?.program;
    ...
    return (
        <div className="max-w-2xl mx-auto space-y-8">
            ...
            <Card className="overflow-hidden">
                <div className="bg-gradient-to-r from-green-500 to-emerald-600 p-8 text-white text-center">
                    ...
                    <h1 className="text-3xl font-bold mb-2">
                        Welcome to {program?.name || "the Academy"}!
                    </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
                <Link href="/account/academy" className="flex-1">
