  ...
  return (
    <div className="space-y-8">
      ...
      <header className="space-y-2">
        ...
        <h1 className="text-3xl font-bold text-slate-900">Browse Programs</h1>
        <p className="text-slate-600">
          Explore our structured swimming programs and find the right fit for
          your skill level.
        </p>
      </header>
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-slate-600">
              Our Beginner 1 program is perfect for adults learning to swim from
              scratch.
            </p>
          </div>
          <Button onClick={() => setSelectedLevel(ProgramLevel.BEGINNER_1)}>
