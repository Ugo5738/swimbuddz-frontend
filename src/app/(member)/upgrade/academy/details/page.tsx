...
export default function AcademyDetailsPage() {
    ...
    const { state, setAcademyDetailsData, markAcademyDetailsComplete } = useUpgrade();
    ...
    const [formData, setFormData] = useState<{
        ...
        academySkillAssessment: (state.academyDetailsData?.skillAssessment as any) || {
            canFloat: false,
        ...
        academyPreferredCoachGender: state.academyDetailsData?.preferredCoachGender || "",
        ...
        <div className="space-y-6">
            ...
            <div className="text-center space-y-3">
                ...
                <p className="text-slate-600 max-w-md mx-auto">
                    Tell us about your current skills and learning goals so we can provide the best
                    coaching experience.
                </p>
            </div>
            ...
            <Card className="p-6">
                ...
                <div className="mt-8 flex justify-end">
                    <Button onClick={handleSubmit} disabled={!isValid || saving} size="lg">
