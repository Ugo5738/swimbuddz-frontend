            ...
            {sessions.map((session) => {
              ...
              return (
                <Card
                  ...
                  className={
                    isBooked
                      ? "overflow-hidden p-0 ring-2 ring-emerald-400 bg-emerald-50/40"
                      : !canBook
                ...
                >
                  ...
                  {isBooked && (
                    <div className="flex items-center gap-2 bg-emerald-500 px-6 py-2.5">
                  ...
                  <div className={isBooked ? "space-y-4 p-6" : "space-y-4"}>
                    {/* Title + badges row */}
