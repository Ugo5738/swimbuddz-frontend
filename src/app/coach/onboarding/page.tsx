...
export default function CoachOnboardingPage() {
  ...
  const toggleArrayValue = (
    field: keyof CoachOnboardingData,
    value: string,
  ) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const wantsGroup =
        preferred.includes("group") || preferred.includes("academy");
  ...
  const isRemoteOnly = (formData.pools_supported || []).includes(
    "remote_global",
  );
  const showTravelRadius =
    formData.can_travel_between_pools && hasPhysicalLocation;
        ...
        <Card className="p-6 space-y-6">
          ...
          {agreementSigned ? (
            ...
            <div className="space-y-4">
              <p className="text-sm text-slate-600">
                Before you can start coaching, you must read and sign our Coach
                Agreement. This agreement outlines your responsibilities,
                compensation structure, and code of conduct.
              </p>
              <Link href="/coach/agreement?returnTo=/coach/onboarding">
                <Button className="w-full">Review & Sign Agreement</Button>
              </Link>
              <button
        ...
        <Card className="p-6 space-y-8">
            ...
            <fieldset className="space-y-2">
              ...
              <div className="flex flex-wrap gap-2">
                {locationOptions.map((opt) => {
                  const isSelected = (formData.pools_supported || []).includes(
                    opt.value,
                  );
                  const isDisabled =
            ...
            {hasPhysicalLocation && (
              <Checkbox
                ...
                onChange={(e) =>
                  setFormData({
                    ...formData,
                    can_travel_between_pools: e.target.checked,
                  })
                }
              />
            )}
          ...
          <div className="space-y-4">
            ...
            <OptionPillGroup
              ...
              onToggle={(value) =>
                toggleArrayValue("preferred_cohort_types", value)
              }
            />
