...
export default function CoachAgreementPage() {
  ...
  const [signatureType, setSignatureType] =
    useState<SignatureType>("typed_name");
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      {status && (
        <Card
          className={`p-4 ${status.has_signed_current_version ? "bg-green-50 border-green-200" : "bg-amber-50 border-amber-200"}`}
        >
      ...
      {showSigningForm && !status?.has_signed_current_version && (
        <Card className="p-6 space-y-6">
          ...
          <div className="space-y-3">
            ...
            <div className="flex gap-4">
              ...
              >
                ...
                <p className="text-sm text-slate-600">Draw your signature</p>
              </button>
              <button
                type="button"
              ...
              >
                ...
                <p className="text-sm text-slate-600">Agree with a checkbox</p>
              </button>
            </div>
          </div>
          ...
          <div className="flex items-center justify-end gap-4 pt-4 border-t border-slate-200">
            <Button variant="outline" onClick={() => setShowSigningForm(false)}>
              Cancel
            </Button>
              ...
              >
                <div>
                  ...
                  <p className="text-sm text-slate-600">
                    ...
                    {item.signature_type === "typed_name" ? "typed" : "drawn"})
                  </p>
                </div>
