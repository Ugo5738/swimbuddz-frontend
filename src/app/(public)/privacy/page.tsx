...
const sections: Section[] = [
  {
    title: "1) Who We Are",
    content: [
      { type: "paragraph", text: "SwimBuddz (“we”, “us”, “our”) runs a community for swimming meetups, training, and events." },
      { type: "paragraph", text: "Data Controller: Daniel Nwachukwu" },
      { type: "paragraph", text: "Contact: contactugodaniels@gmail.com | +234 703 358 8400" }
    ]
  },
  {
  ...
  },
  {
    ...
    content: [
      ...
      { type: "link", text: "The latest version lives on Google Docs", href: privacyDocUrl }
    ]
  },
  {
    title: "15) Contact",
    content: [
      ...
      { type: "paragraph", text: "Daniel Nwachukwu — contactugodaniels@gmail.com | +234 703 358 8400" }
    ]
  }
];
  ...
  return (
    <div className="space-y-10">
      <header className="space-y-2">
        <p className="text-sm font-semibold uppercase tracking-[0.3em] text-cyan-600">Privacy & trust</p>
        <h1 className="text-4xl font-bold text-slate-900">SwimBuddz Privacy Policy</h1>
        <p className="text-base text-slate-600">Last Updated: 19 October, 2025</p>
        <p className="text-lg text-slate-600">
          We collect only what SwimBuddz needs to run safe, coordinated sessions. Review the full policy below before onboarding.
        </p>
      </header>
