...
export default function CoachProfilePage() {
      ...
      <div className="max-w-4xl mx-auto">
        <Card className="p-12 text-center">
          ...
          <p className="text-slate-600 mb-4">
            {error ||
              "The coach you're looking for doesn't exist or is not currently active."}
          </p>
  ...
  const displayName =
    coachProfile?.display_name || `${coach.first_name} ${coach.last_name}`;
  const photoUrl =
    coachProfile?.coach_profile_photo_url || coach.profile_photo_url;
  ...
  const pastCohorts = cohorts.filter(
    (c) => c.status === CohortStatus.COMPLETED,
  );
      ...
      <Card className="overflow-hidden">
        <div className="bg-gradient-to-br from-slate-800 via-slate-900 to-cyan-900 p-6 md:p-8">
          <div className="flex flex-col items-center text-center">
            ...
            {/* Specialties */}
            {coachProfile?.coaching_specialties &&
              coachProfile.coaching_specialties.length > 0 && (
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        <div className="space-y-6">
          ...
          <Card className="p-6">
            ...
            {/* Age Groups */}
            {coachProfile?.age_groups_taught &&
              coachProfile.age_groups_taught.length > 0 && (
                <div className="mb-4">
                  <p className="text-xs text-slate-500 font-medium mb-2 uppercase tracking-wide">
                    Age Groups
                  </p>
            ...
            {/* Languages */}
            {coachProfile?.languages_spoken &&
              coachProfile.languages_spoken.length > 0 && (
                <div>
                  <p className="text-xs text-slate-500 font-medium mb-2 uppercase tracking-wide">
                    Languages
                  </p>
