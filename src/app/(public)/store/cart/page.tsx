...
export default function CartPage() {
    const { cart, loading, updateItem, removeItem, applyDiscount, removeDiscount, isAuthenticated } = useStoreCart();
                        ...
                        <Card className="p-6 sticky top-24">
                            ...
                            <div className="space-y-3 text-sm">
                                ...
                                <div className="pt-3 border-t border-slate-200 flex justify-between text-base font-semibold">
                                    ...
                                    <span className="text-cyan-600">₦{cart?.total_ngn.toLocaleString()}</span>
                                </div>
                            </div>
