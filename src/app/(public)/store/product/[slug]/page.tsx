...
export default function ProductDetailPage() {
  ...
  const basePrice =
    selectedVariant?.price_override_ngn ?? product.base_price_ngn;
  const finalPrice =
    memberDiscount > 0 ? basePrice * (1 - memberDiscount / 100) : basePrice;
  const hasDiscount =
    product.compare_at_price_ngn && product.compare_at_price_ngn > basePrice;
      ...
      <div className="grid lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-6">
          ...
          {product.variant_options &&
            Object.keys(product.variant_options).length > 0 && (
              <div className="space-y-4">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {values.map((value) => {
                          ...
                          const isAvailable = product.variants.some(
                            (v) =>
                              v.options[optionName] === value && v.is_active,
                          );
                          return (
                            <button
                              key={value}
              ...
              <div className="flex items-start gap-3">
                <label className="flex items-start gap-3 cursor-pointer">
                  ...
                  <span className="text-sm text-amber-800">
                    ...
                    and understand that swimwear sizing may vary. All sales are
                    final.
                  </span>
                </label>
              </div>
