...
const benefits: Benefit[] = [
  ...
  },
  {
    ...
    description:
      "Weekly or bi-weekly coached sessions. Ongoing swimming exercise at your pace.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Organize Ride-Share transportation with other members per session.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Technique workshops, fun races, themed sessions, fitness days, etc.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Earn and display titles like Best Freestyle, Most Improved, Distance King/Queen, etc., visible on your public profile.",
  },
  {
    title: "Participation in External Activities",
    description:
      "Access to triathlons, open water swims, swimming festivals, team relays, and partner events.",
  },
];
...
const trainingStructure = [
  {
    ...
    description:
      "Focus sessions on specific strokes, breathing patterns, and form improvements.",
  },
  {
    title: "Performance Squads",
    description:
      "Group training for swimmers looking to build endurance and speed.",
  },
  {
    title: "Consistency Tracking",
    description:
      "Your attendance and punctuality are tracked to help you stay accountable.",
  },
];
    ...
    <div className="space-y-12">
      ...
      <section className="space-y-6">
        ...
        <p className="text-lg text-slate-600 max-w-3xl">
          For swimmers who want structured, ongoing improvement and belong to an
          active swimming group. Ongoing swimming at your pace.
        </p>
      </section>
      ...
      <section className="rounded-3xl bg-gradient-to-br from-cyan-600 to-cyan-700 px-8 py-12 text-center text-white">
        ...
        <p className="text-lg mb-6 text-cyan-50 max-w-2xl mx-auto">
          Anyone who wants to swim regularly, get better, be part of a training
          culture, and track progress month-by-month.
        </p>
        <Link
          href="/register"
