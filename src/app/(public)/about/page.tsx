...
const approach = [
  {
    title: "Safety",
    description:
      "We prioritize safe environments, respect for pool rules, and a culture where people look out for one another.",
  },
  {
    title: "Consistency",
    description:
      "Progress in swimming comes from showing up. Our structure (sessions, check-ins, cohorts) is designed to help you keep going.",
  },
  {
    title: "Community",
    description:
      "SwimBuddz is not just lanes and drills. It's conversations, encouragement, shared struggles and small wins celebrated together.",
  },
];
...
const facilities = [
  {
    ...
    description:
      "We train in full-length 50m pools for Club sessions. This builds true endurance and prepares you for real-world swimming conditions.",
  },
  {
    type: "Intimate Learning Pools",
    description:
      "For Academy beginners, we use smaller, calmer pools. This reduces anxiety and lets you focus 100% on technique without distractions.",
  },
];
...
const getInvolved = [
  {
    ...
    description:
      "Create an account, fill out your profile, and start receiving announcements and updates.",
    link: "/register",
  },
  {
    title: "Join the Club Sessions",
    description:
      "Once you're ready, sign up for Club training sessions and start building consistency with others.",
    link: "/sessions-and-events",
  },
  {
    title: "Enroll in the Academy",
    description:
      "If you're a beginner or you want a structured learning path, enroll in an Academy program when applications open.",
    link: "/academy",
  },
  {
    title: "Volunteer",
    description:
      "If you enjoy media, logistics, coordination or helping others, you can indicate your interest in volunteer roles inside your profile.",
      ...
      <section className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-cyan-500 via-cyan-600 to-blue-700 px-8 py-16 text-white md:py-20">
        ...
        <div className="absolute top-0 left-0 right-0 text-cyan-400/30">
          <svg
            ...
            className="w-full rotate-180 h-12 md:h-16"
          >
            <path
        ...
        <div className="relative z-10 space-y-8 max-w-3xl mx-auto text-center">
          ...
          <p className="text-xl text-cyan-50">We imagine a world where:</p>
          ...
          <ul className="space-y-4 text-lg text-left max-w-2xl mx-auto">
            <li className="flex items-start gap-4 bg-white/10 backdrop-blur-sm rounded-2xl p-4">
              ...
              <span className="text-cyan-50 pt-1">
                More adults are comfortable and confident in the water.
              </span>
            </li>
            <li className="flex items-start gap-4 bg-white/10 backdrop-blur-sm rounded-2xl p-4">
              <span className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-xl bg-white/20 text-xl">
              ...
              <span className="text-cyan-50 pt-1">
                Swimming is seen as a normal part of a healthy lifestyle.
              </span>
            </li>
            <li className="flex items-start gap-4 bg-white/10 backdrop-blur-sm rounded-2xl p-4">
              <span className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-xl bg-white/20 text-xl">
              ...
              <span className="text-cyan-50 pt-1">
                Community, not isolation, is what keeps people going.
              </span>
            </li>
          </ul>
