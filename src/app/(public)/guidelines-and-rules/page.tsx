...
const sections: Section[] = [
  {
    ...
    content: [
      { type: "paragraph", text: "SwimBuddz is a community built around a shared passion for swimming. Our goals are to:" },
      {
        type: "list",
        items: [
  ...
  },
  {
    ...
    content: [
      { type: "paragraph", text: "To help everyone learn and grow at their own pace, we have different skill levels." },
      ...
      { type: "paragraph", text: "Mentorship and peer support are encouraged at all levels." }
    ]
  },
  {
  ...
  },
  {
    ...
    content: [
      ...
      { type: "paragraph", text: "We’ll also run periodic challenges (e.g., distance streaks, technique weeks) to keep motivation high." }
    ]
  },
  {
  ...
  },
  {
    ...
    content: [
      { type: "paragraph", text: "To protect the group’s safety and focus, admins may:" },
      {
        type: "list",
        items: [
  ...
  },
  {
    ...
    content: [
      ...
      { type: "paragraph", text: "Version control: The latest guidelines are always available at the shared document link." },
  ...
  return (
    <div className="space-y-10">
      <header className="space-y-2">
        ...
        <h1 className="text-4xl font-bold text-slate-900">🏊‍♂️ SwimBuddz Community Rules &amp; Safety Guidelines</h1>
        <p className="text-base text-slate-600">Last Updated: 19 October, 2025</p>
        <p className="text-lg text-slate-600">
          Our mission is to build a fun, supportive, and safe community that helps swimmers at every level improve, stay consistent, and enjoy the water.
          By participating in SwimBuddz activities or group discussions, you agree to follow the guidelines below.
        </p>
      </header>

      <section className="space-y-8">
        {sections.map((section) => (
          <article key={section.title} className="space-y-3 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
            ...
            {section.content.map((block, index) => {
              ...
              if (block.type === "subtitle") {
                return (
                  <p key={index} className="text-sm font-semibold uppercase tracking-wide text-slate-500">
                    {block.text}
                  </p>
                );
              }
              ...
              if (block.type === "link") {
                return (
                  <Link key={index} href={block.href} target="_blank" className="inline-flex text-sm font-semibold text-cyan-700 hover:underline">
                    {block.text} &rarr;
                  </Link>
                );
              }
      ...
      <section className="space-y-3 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <p className="text-sm text-slate-600">📧 Email: contactugodaniels@gmail.com</p>
