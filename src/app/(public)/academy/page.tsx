...
const benefits: Benefit[] = [
  ...
  },
  {
    ...
    description:
      "(e.g., water comfort → floating → breathing → kick → arm movement → full stroke → endurance → efficiency)",
  },
  {
    title: "Coach-Assigned Drills and Goals",
    description:
      "Each swimmer receives personalized tasks to complete between sessions.",
  },
  {
  ...
  },
  {
    ...
    description:
      "4+ weeks programs with classmates starting and graduating together.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Coaches review your technique and provide annotated feedback.",
  },
  {
    title: "Certification / Level Badge",
    description:
      "At the end of the cohort, swimmers receive badges/certificates showing their achieved level.",
  },
  {
    title: "Premium Resources",
    description:
      "Access to exclusive academy materials, drills library, progression charts, and bonus sessions.",
  },
  {
...
const learningPaths = [
  {
    ...
    description:
      "Water comfort, floating, breathing, and basic stroke introduction.",
    milestones: [
      "Water confidence",
      "Floating",
      "Breathing control",
  ...
  },
  {
    ...
    description:
      "Refine strokes, build endurance, and improve technique across all four strokes.",
    milestones: [
      "All four strokes",
      "Endurance building",
      "Flip turns",
  ...
  },
  {
    ...
    description:
      "Open water training, advanced techniques, and competitive swim preparation.",
    milestones: [
      "Open water skills",
      "Race strategy",
      "Advanced drills",
    ...
    <div className="space-y-12">
      ...
      <section className="space-y-6">
        ...
        <h1 className="text-4xl font-bold text-slate-900 md:text-5xl">
          A formal training program with a curriculum, assessments, and
          certification.
        </h1>
        <p className="text-lg text-slate-600 max-w-3xl">
          From water comfort to advanced strokes. Access advanced training
          materials, dedicated academy-only events, and a more focused learning
          environment.
        </p>
      </section>
      ...
      <section className="rounded-3xl bg-gradient-to-br from-cyan-600 to-cyan-700 px-8 py-12 text-center text-white">
        ...
        <p className="text-lg mb-6 text-cyan-50 max-w-2xl mx-auto">
          Beginners who want to learn properly from scratch, or intermediates
          who want structured professional guidance and a clear progression
          path. Perfect for people who want to achieve something specific in a
          set timeframe.
        </p>
        <Link
          href="/register"
