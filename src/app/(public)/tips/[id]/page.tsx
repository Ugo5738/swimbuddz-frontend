            ...
            if (response.ok) {
                ...
                if (relatedResponse.ok) {
                    ...
                    const filtered = relatedData
                        .filter((p: ContentPost) => p.id !== postId && p.tier_access === "community")
                        .slice(0, 3);
                    ...
                    {error.includes("members") ? (
                        <>
                            ...
                            <p className="mt-2 text-slate-600 max-w-md mx-auto">
                                This article is exclusively available to SwimBuddz members.
                                Join us to access all our premium content!
                            </p>
                            <Link
                                href="/register"
        ...
        <div className="space-y-10">
            ...
            <article className="max-w-3xl mx-auto">
                ...
                <header className="space-y-4 mb-8">
                    <div className="flex flex-wrap items-center gap-3">
                        <span
                            className={`text-sm font-semibold px-3 py-1 rounded-full ${categoryColors[post.category] || categoryColors.general
                                }`}
                        >
            ...
            <Card className="p-8 bg-gradient-to-br from-cyan-50 to-white border-cyan-100 text-center">
                ...
                <p className="mt-2 text-slate-600 max-w-xl mx-auto">
                    Join SwimBuddz to get access to coaches, structured programs,
                    and a supportive community to help you achieve your swimming goals.
                </p>
