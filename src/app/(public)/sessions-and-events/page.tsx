    ...
    <div className="space-y-8">
      ...
      <section className="space-y-4">
        ...
        <p className="text-lg text-slate-600 max-w-3xl">
          Join upcoming Club training sessions or RSVP to community events. Stay
          connected and show up consistently.
        </p>
      </section>
    ...
    <div className="space-y-6">
      <div className="rounded-lg bg-cyan-50 p-4 border border-cyan-100">
        <p className="text-sm text-cyan-900">
          <span className="font-semibold">Club members:</span> Browse and sign
          in to upcoming training sessions below. Not a Club member yet?{" "}
          <Link
            href="/club"
      ...
      <Card className="p-8 text-center">
        <p className="text-slate-600 mb-4">
          Club sessions are managed through the member dashboard once you're
          signed in.
        </p>
        <Link
          href="/sessions"
...
function CommunityEventsTab() {
  return (
    <div className="space-y-6">
      <div className="rounded-lg bg-cyan-50 p-4 border border-cyan-100">
        <p className="text-sm text-cyan-900">
          <span className="font-semibold">Community events</span> are open to
          all SwimBuddz members. Beach days, hangouts, watch parties, and more!
        </p>
      </div>
