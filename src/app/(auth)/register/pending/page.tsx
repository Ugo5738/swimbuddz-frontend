        ...
        {status === "pending" && (
          <>
            ...
            <p className="text-slate-600 mb-6">
              Your account is currently under review. Our team is reviewing your
              application to ensure SwimBuddz is a safe and welcoming community
              for everyone.
            </p>
        ...
        {status === "rejected" && (
          <>
            ...
            <p className="text-slate-600 mb-6">
              ...
              This could be due to incomplete information or not meeting our
            ...
            <div className="bg-slate-50 rounded-xl p-6 mb-6 text-left">
              ...
              <p className="text-sm text-slate-600">
                ...
                more information, you can register again with a complete
                profile.
              </p>
            </div>
