            ...
            <div className="flex gap-4">
              ...
              <div className="flex-1">
                ...
                <div className="mt-3 p-3 bg-slate-50 rounded-lg">
                  ...
                  {resendMessage && (
                    <p
                      className={`mt-2 text-xs ${resendMessage.type === "success" ? "text-green-600" : "text-red-600"}`}
                    >
                      {resendMessage.text}
                    </p>
                  )}
      ...
      <Card className="space-y-6 p-6">
        ...
        <div className="space-y-4">
          ...
          <div className="flex gap-4">
            ...
            <div>
              <h3 className="font-medium text-slate-900">
                Activate Community (₦20,000 / year)
              </h3>
              <p className="mt-1 text-sm text-slate-600">
                After you confirm your email and log in, you'll be prompted to
                activate your annual Community membership to unlock member
                features.
              </p>
            </div>
          </div>
