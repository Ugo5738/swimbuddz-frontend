...
export type CoachProfileResponse =
  components["schemas"]["CoachProfileResponse"];
export type CoachApplicationCreate =
  components["schemas"]["CoachApplicationCreate"];
export type CoachApplicationResponse =
  components["schemas"]["CoachApplicationResponse"];
export type CoachApplicationStatusResponse =
  components["schemas"]["CoachApplicationStatusResponse"];
export type CoachOnboardingUpdate =
  components["schemas"]["CoachOnboardingUpdate"];
export type CoachProfileUpdate = components["schemas"]["CoachProfileUpdate"];
export type AdminCoachApplicationListItem =
  components["schemas"]["AdminCoachApplicationListItem"];
export type AdminCoachApplicationDetail =
  components["schemas"]["AdminCoachApplicationDetail"];
...
export const CoachesApi = {
  ...
  apply: (data: CoachApplicationData) =>
    apiPost<CoachApplicationResponse>("/api/v1/coaches/apply", data, {
      auth: true,
    }),
  ...
  updateMe: (data: CoachProfileUpdate) =>
    apiPatch<CoachApplicationResponse>("/api/v1/coaches/me", data, {
      auth: true,
    }),
  ...
  getApplicationStatus: () =>
    apiGet<CoachApplicationStatusResponse>(
  ...
  completeOnboarding: (data: CoachOnboardingData) =>
    apiPost<CoachApplicationResponse>("/api/v1/coaches/me/onboarding", data, {
      auth: true,
    }),
  ...
  listApplications: (status?: string) => {
    ...
    return apiGet<AdminCoachApplicationListItem[]>(
      `/api/v1/admin/coaches/applications${params}`,
      { auth: true },
    );
  },
  ...
  getApplication: (id: string) =>
    apiGet<AdminCoachApplicationDetail>(
      `/api/v1/admin/coaches/applications/${id}`,
      { auth: true },
    ),
  ...
  deleteApplication: (id: string) =>
    apiDelete<{ message: string }>(`/api/v1/admin/coaches/applications/${id}`, {
      auth: true,
    }),
  ...
  getGrades: (coachProfileId: string) =>
    apiGet<CoachGradesData>(`/api/v1/admin/coaches/${coachProfileId}/grades`, {
      auth: true,
    }),
  ...
  updateGrades: (coachProfileId: string, data: UpdateCoachGradesData) =>
    apiPut<CoachGradesData>(
      `/api/v1/admin/coaches/${coachProfileId}/grades`,
      data,
      { auth: true },
    ),
  ...
  suggestGrades: (coachProfileId: string) =>
    apiPost<CoachGradeSuggestion>(
      `/api/v1/admin/coaches/${coachProfileId}/suggest-grades`,
      {},
      { auth: true },
    ),
};
...
export const AgreementApi = {
   ...
   */
  getCurrentAgreement: () =>
    apiGet<AgreementContent>("/api/v1/coaches/agreement/current", {
      auth: true,
    }),
  ...
  signAgreement: (data: SignAgreementRequest) =>
    apiPost<CoachAgreementResponse>("/api/v1/coaches/agreement/sign", data, {
      auth: true,
    }),
   ...
   */
  getAgreementHistory: () =>
    apiGet<AgreementHistoryItem[]>("/api/v1/coaches/agreement/history", {
      auth: true,
    }),
};
...
export const AdminAgreementApi = {
  ...
  create: (data: CreateAgreementVersionRequest) =>
    apiPost<AgreementVersionDetail>("/api/v1/admin/coaches/agreements", data, {
      auth: true,
    }),
};
...
export const HandbookApi = {
  ...
  getHandbookVersion: (version: string) =>
    apiGet<HandbookContent>(`/api/v1/coaches/handbook/${version}`, {
      auth: true,
    }),
};
...
export const AdminHandbookApi = {
   ...
   */
  list: () =>
    apiGet<HandbookVersionListItem[]>(
  ...
  create: (data: {
    ...
    apiPost<HandbookVersionListItem>("/api/v1/admin/coaches/handbook", data, {
      auth: true,
    }),
};
