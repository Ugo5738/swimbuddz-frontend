        ...
        <div className="space-y-8">
            ...
            <div className="text-center space-y-3">
                ...
                <p className="text-slate-600 max-w-lg mx-auto">
                    Select the tier that best matches your swimming goals. You can always upgrade later as you progress.
                </p>
            </div>
            ...
            <div className="grid gap-6 lg:grid-cols-3">
                {tierOptions.map((tier) => {
                    ...
                    return (
                        <div
                            key={tier.value}
                            className={`relative rounded-2xl transition-all duration-200 ${isDisabled
                        ...
                        >
                            ...
                            {/* Selected Check */}
                            {isSelected && (
                                <div className={`absolute top-4 right-4 w-8 h-8 rounded-full ${colors.icon} flex items-center justify-center`}>
                            ...
                            <div className="p-6 space-y-5">
                                ...
                                >
                                    {isSelected ? "✓ Selected" : isDisabled ? "Current Tier" : "Select This Tier"}
                                </button>
                            </div>
                        </div>
                    );
            ...
            {selectedTier && (
                <div className="text-center p-4 rounded-xl bg-gradient-to-r from-cyan-50 to-blue-50 border border-cyan-100">
                    <p className="text-sm text-cyan-900">
                        <span className="font-semibold">Great choice!</span> You selected the{" "}
