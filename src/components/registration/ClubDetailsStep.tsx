...
export function ClubDetailsStep({
  ...
  const allLocationsSelected =
    ...
    locationValues.every((value) =>
      formData.locationPreference.includes(value),
    );
  ...
  const handleLocationToggle = (value: string) => {
    if (mode === "onboarding" && value === SELECT_ALL_VALUE) {
      onUpdate(
        "locationPreference",
        allLocationsSelected ? [] : locationValues,
      );
      return;
    }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-4 rounded-lg border border-slate-200 bg-slate-50 p-4">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <Input
            ...
            onChange={(e) =>
              onUpdate("emergencyContactRelationship", e.target.value)
            }
      ...
      <OptionPillGroup
        ...
        hint={
          mode === "onboarding"
            ? "Select all areas you can train in"
            : "Select all locations you're willing to train at"
        }
      />
