    ...
    <div className="space-y-8">
      <div className="space-y-2">
        ...
        <p className="text-sm text-slate-600">
          Tell us a bit more about yourself to help us personalize your
          experience.
        </p>
      </div>
      ...
      {formData.volunteerInterest.length > 0 && (
        <div className="rounded-lg bg-emerald-50 p-4">
          <p className="text-sm text-emerald-900">
            <strong>Thank you for your interest in volunteering!</strong> We'll
            reach out when opportunities matching your interests become
            available.
          </p>
        </div>
      )}
      ...
      <div className="space-y-2 rounded-lg border border-slate-200 bg-slate-50 p-4">
        ...
        <p className="text-sm text-slate-600">
          Can we feature you in photos/videos for social media and promotional
          materials?
        </p>
      ...
      <div className="space-y-3 rounded-lg border border-slate-200 bg-slate-50 p-4">
        ...
        <p className="text-sm text-slate-600">
          Would you like to appear in the member directory? This helps other
          members connect with you based on shared interests and swimming goals.
        </p>
        ...
        <label className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="mt-1 text-xs text-slate-500">
              Only your name, city, swim level, and selected interests will be
