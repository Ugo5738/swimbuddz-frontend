        ...
        <div className="space-y-4 border-t pt-4">
          <div>
            ...
            <p className="mt-1 text-xs text-slate-500">
              Price and Membership policy changes apply to new enrollments. Existing enrollments
              keep their stored terms; older enrollments without a snapshot use the current settings.
            </p>
          </div>
