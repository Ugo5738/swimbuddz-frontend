...
export function PhotoModal({
    ...
    return (
        ...
        >
            ...
            {/* Photo Container */}
            <div
                className={`relative flex flex-col items-center max-w-[90vw] max-h-[85vh] transition-transform duration-300 ${isVisible ? "scale-100" : "scale-95"
            ...
            >
                ...
                <img
                    src={photo.file_url}
                    alt={caption || 'Photo'}
                    className={`max-w-full max-h-[75vh] object-contain rounded-lg shadow-2xl transition-all duration-300 ${isZoomed ? "scale-150 cursor-zoom-out" : "scale-100"
                ...
                {/* Caption */}
                {caption && isLoaded && (
                    <div className={`mt-4 px-6 py-3 bg-white/10 rounded-xl backdrop-blur-sm max-w-2xl transition-all duration-300 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
                        }`}>
