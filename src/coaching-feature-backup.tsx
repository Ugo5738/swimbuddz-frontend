...
export function CoachingDetails({ profile }: { profile: CoachingProfile }) {
    return (
        <div className="space-y-4">
            ...
            <div>
                <span className="font-medium">Experience:</span> {profile.coachingExperience || "--"}
            </div>
            <div>
            ...
            <div>
                <span className="font-medium">Years Coaching:</span> {profile.coachingYears || "--"}
            </div>
            <div>
                <span className="font-medium">Portfolio:</span> {profile.coachingPortfolioLink || "--"}
            </div>
            <div>
                <span className="font-medium">Documents:</span> {profile.coachingDocumentLink || "--"}
            </div>
        </div>
    );
}
